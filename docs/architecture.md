...
| client | discovery, 등록, 재접속 backoff | 무엇을 그릴지 |
...
4. `tests/roster.json`에 표시 이름과 renderer id를 기록하고 overlay package 내부 `assets/`를 추가한다.
